...
function eventListeners() {
  ...
  Checkout.addEventListener('click', () => {
    // ui.addToCart.showTotals;
    alert("Bayar Sejumlah : " + showTotals());
  });
}
...
addEventListener("click", showTotals);